...
# read expr
expr.file = paste0("~/SCRATCH/eqtl/expr/", disease, "/expr.residuals.rda")
load(expr.file)

# read clin
clin.file = paste0("~/SCRATCH/eqtl/expr/", disease, "/clin.txt")
...
outfile = paste0("~/SCRATCH/eqtl/expr/peer/", disease, "/", disease, ".GE.PEER-", nPeer, ".txt")
